...
function FontPage() {
  ...
  <div className='login-box'>
      ...
      <input type="text" name="username" placeholder="Enter Seater" value={seater} onChange={(event) => {
			...
			{/* <input type="submit" name="submit" value="Login"/> */}
      <p>FuelType</p>
      <input type="text" name="username" placeholder="Enter Fuel Type" value={fueltype} onChange={(event) => {
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button class="btn btn-primary" style={{padding:12,borderRadius:10,backgroundColor:'Tomato'}}>
                <Link to='/main' class='but'>Back</Link>
                </button>
		</form>
	</div>
  );
